...
class VueJeu():
    def __init__(self, root) :
        ...
        self.carreBackground = Carre(self.canvas, Vecteur(350, 350), 500, 0, remplissage="black", bordure="black", epaisseur=0)
        #Aire de jeu blanc où il est possible de déplacer le carré rouge 
        self.carreAireJeu = Carre(self.canvas, Vecteur(350, 350), 450, 0, remplissage="white", bordure="black", epaisseur=0)
